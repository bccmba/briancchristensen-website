document.addEventListener('DOMContentLoaded', () => {
  // Post data - generated statically
    const posts = [
    { slug: "the-10x-day.html", title: "The 10× Day", date: "May 30, 2026", category: "ai", excerpt: "We told our developers to turn off their IDEs and let AI do the work. By end of day they'd moved two applications each — a 10× change in throughput. Here's the result, and the five things I'm not yet concluding from it.", readingTime: 4 },
    { slug: "the-one-good-shot-problem-what-golf-taught-me-about-ai.html", title: "The One Good Shot Problem: What Golf Taught Me About AI", date: "April 24, 2026", category: "ai", excerpt: "AI success feels like fireworks — the jaw-dropping demo, the perfect output. But what AI success actually requires looks a lot more like a lighthouse. A lesson from the golf course.", readingTime: 7 },
    { slug: "stop-measuring-outputs-start-delivering-outcomes.html", title: "Stop Measuring Outputs. Start Delivering Outcomes.", date: "April 17, 2026", category: "pm", excerpt: "After 20 years in product management, the single biggest mindset shift separating great PMs from good ones isn't technical skill or agile certification. It's the move from outputs to outcomes — and most teams are still getting it wrong.", readingTime: 9 },
    ...
    { slug: "starting-strong-as-a-new-product-owner-why-focusing-on-the-next-new-feature-is-key.html", title: "Starting Strong as a New Product Owner", date: "December 25, 2021", category: "ai", excerpt: "Starting as a new product owner can be both exciting and overwhelming.", readingTime: 4 },
    ...
    { slug: "the-radical-shift-in-product-management-pros-and-cons-of-major-change.html", title: "The Radical Shift in Product Management", date: "December 4, 2021", category: "ai", excerpt: "In today's fast-paced business environment, radical shifts in product management are becoming increasingly common.", readingTime: 6 },
    ...
    { slug: "the-ultimate-guide-to-managing-technical-debt-as-a-product-manager.html", title: "The Ultimate Guide to Managing Technical Debt", date: "November 20, 2021", category: "ai", excerpt: "Technical debt is a common challenge that Product Managers face in software development.", readingTime: 5 },
    { slug: "the-wisdom-of-jurassic-park-a-lesson-for-product-managers.html", title: "The Wisdom of Jurassic Park: A Lesson for Product Managers", date: "November 13, 2021", category: "ai", excerpt: "As we navigate the dynamic landscape of product management, lessons can come from unexpected places.", readingTime: 3 },
    ...
    { slug: "mastering-innovation-unleashing-the-power-of-the-product-kata.html", title: "Mastering Innovation: Unleashing the Power of the Product Kata", date: "October 23, 2021", category: "ai", excerpt: "In the dynamic realm of product management, innovation is the key to staying ahead.", readingTime: 4 },
    ...
    { slug: "proactive-software-development-vs-reactive-software-development-which-approach-is-best-for-your-business.html", title: "Proactive Software Development vs Reactive Software Development", date: "September 11, 2021", category: "ai", excerpt: "In today's fast-paced world of software development, teams are constantly deciding between being proactive or reactive.", readingTime: 3 },
...
function renderPosts(filteredPosts) {
  ...
  postsContainer.innerHTML = visible.map(post => `
  ...
  if (filteredPosts.length > visibleCount) {
    if (!btn) {
      ...
      btn.id = 'loadMoreBtn';
      btn.style.cssText = 'grid-column:1/-1;text-align:center;padding:2rem 0;';
      btn.innerHTML = '<button onclick="loadMore()" style="background:none;border:1.5px solid #1B3A5C;color:#1B3A5C;font-family:var(--font-sans);font-size:14px;font-weight:500;padding:12px 32px;border-radius:99px;cursor:pointer;">Load more posts</button>';
